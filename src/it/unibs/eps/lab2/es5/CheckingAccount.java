...
public class CheckingAccount extends BankAccount
{
    ...
    public String toString() {
    	return super.toString() + String.format(" transactionCount = %d", transactionCount);
    }
    
    @Override
    public boolean equals(Object otherObject) {
    	return super.equals(otherObject) && transactionCount == ((CheckingAccount) otherObject).transactionCount;
