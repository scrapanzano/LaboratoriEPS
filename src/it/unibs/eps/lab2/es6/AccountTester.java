    ...
    private static void testAccount(BankAccount a)
    {
        ...
        */
        ...
        if (a instanceof TimeDepositAccount)
        {
            ...
            tda.withdraw(100); // prelievo soggetto a penale
            System.out.println("Stato dopo Prelievo (con penale):\n     " + a);
            tda.addInterest();  // facciamo passare il sesto mese
            System.out.println("Interessi dopo 6 mesi:\n     " + a);
            tda.withdraw(100); // prelievo non piu` soggetto a penale
            System.out.println("Stato dopo Prelievo (no penale):\n     " + a);
     
        	
        	newa = new TimeDepositAccount(tda.getBalance(), tda.getInterestRate(), tda.getMonthsLeft());
        }
